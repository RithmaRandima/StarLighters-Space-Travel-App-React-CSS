...
import img from "../../Assets/Pricing-About-Pwo.jpeg";
...
const PriceAboutTwo = () => {
  return (
    <div className="w-[100%] h-[90vh] grid grid-cols-1  md:grid-cols-2  overflow-hidden bg-transparent">
      ...
      <div className="hidden md:flex w-[100%] h-[100%] justify-end px-16 relative">
        <div className=" w-[80%] h-[90vh] bg-white">
          <img src={img} className="w-[100%] h-[100%] object-cover" alt="" />
        </div>
        <div className="absolute w-[400px] h-[250px] bottom-[30px] left-[-50px]">
          <video
            autoPlay
            loop
            muted
