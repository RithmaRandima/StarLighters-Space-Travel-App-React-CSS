  ...
  return (
    <div className=" w-[100%] h-[50vh] text-center py-8 mb-10 md:mb-5">
      ...
      <h1 className="text-[25px] md:text-[30px] w-[90%] md:w-[80%] mx-auto font-[600]">
        ...
        imagination for eons and Send Them to the Space
      </h1>
      <p className="text-[18px] tracking-[2px] mt-4">Rithma Randima</p>
      <p className="uppercase text-[10px] font-extrabold text-[blueviolet] tracking-[2px]">
        Founder / CEO
      </p>
    </div>
  );
