  ...
  return (
    <div>
        ...
        <div className="relative w-[100%] h-[100%] bg-black md:ml-[50px]">
          <div className="absolute top-[150px] left-[30px]">
            ...
            <p className="text-white/60 font-[100] leading-7 text-[17px] w-[82%]">
              ...
              Reiciendis voluptas magni sapiente facere porro nesciunt tempora,
              accusamus minus sunt quia cupiditate aperiam. Cumque, distinctio
              similique animi minus accusamus quasi veniam.
            </p>
      ...
      <div className="bg-black w-[100%] h-[25vh] grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-10">
        ...
        <TrainingInfoBox title="Projects" count={"233"} />
      </div>
    </div>
  );
};
